...
@Component({
  selector: 'app-correciones-generadas',
  templateUrl: './correciones-generadas.component.html',
  styleUrls: ['./correciones-generadas.component.scss']
})
export class CorrecionesGeneradasComponent implements OnInit {
