...
@Component({
  selector: 'app-credito-sps',
  templateUrl: './credito-sps.component.html',
  styleUrls: ['./credito-sps.component.scss']
})
export class CreditoSpsComponent implements OnInit {
...
ingresarCredito( ){
  this.sweel.mensajeConConfirmacion(`¿Desea registrar el crédito del empleado ${ this.creditoForm.value.nombreEmpleado } ?`, `Crédito Cafetería`,"warning").then(
    res=>{
        if ( res ){
