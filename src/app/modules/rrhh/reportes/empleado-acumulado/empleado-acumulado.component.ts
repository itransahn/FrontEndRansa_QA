...
@Component({
  selector: 'app-empleado-acumulado',
  templateUrl: './empleado-acumulado.component.html',
  styleUrls: ['./empleado-acumulado.component.scss'],
  providers : [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
   ]
})
export class EmpleadoAcumuladoComponent implements OnInit {
