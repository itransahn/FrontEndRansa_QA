...
@Component({
  ...
  templateUrl: './pases-estandar.component.html',
  styleUrls: ['./pases-estandar.component.scss']
})
export class PasesEstandarComponent implements OnInit {
//Paginacion
public page = 0;
...
Modal ( ){
  const dialogReg = this.dialog.open( CrearpaseEstandarComponent,{
    width :   '1000px',
    height:   'auto',
    maxWidth: 'auto',
    data: {  },
